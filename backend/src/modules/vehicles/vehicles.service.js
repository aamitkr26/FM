...
class VehiclesService {
  async getAll(options) {
    ...
    return _database.prisma.vehicle.findMany({
      where,
      orderBy: {
        registrationNo: 'asc'
      },
  ...
  async getById(id) {
    return _database.prisma.vehicle.findUnique({
      where: {
        id
      }
    });
  ...
  async create(data) {
    return _database.prisma.vehicle.create({
      data
    });
  }
  async update(id, data) {
    return _database.prisma.vehicle.update({
      where: {
        id
      },
      data
  ...
  async delete(id) {
    return _database.prisma.vehicle.delete({
      where: {
        id
      }
    });
